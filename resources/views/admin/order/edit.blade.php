                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <select class="form-control" name="status_pembayaran" id="status_pembayaran" required>
                                ...
                                <option value="sudah lunas" {{ $dataOrder->status_pembayaran == 'sudah lunas' ? 'selected' : '' }}>Sudah Lunas</option>
                                <option value="belum bayar" {{ $dataOrder->status_pembayaran == 'belum bayar' ? 'selected' : '' }}>Belum Bayar</option>
                                <option value="belum lunas" {{ $dataOrder->status_pembayaran == 'belum lunas' ? 'selected' : '' }}>Belum Lunas</option>
                            </select>
                        </div>
